...
public class EnergiaGenerator implements Xbox{
    ...
    public EnergiaGenerator(Jugador jugador) {
    ...
    public void construir(Jugador jugador){
        ...
        Xbox energia = xbox.getXbox("Energia");
        EnergiaGenerator a = new EnergiaGenerator(jugador);
        if(a.getJugador().getCm().getRecurso1() >= costo 
           && a.getJugador().getCm().getRecurso2() >= costo){
            ...
            a.getJugador().getEd3().add(energia);
        }else{
