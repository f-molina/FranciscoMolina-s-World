 ...
 */
//vehiculo1
public class MotherShip implements Xbox{
    ...
    public MotherShip(Jugador jugador) {
    ...
    public void construir(Jugador jugador){
        ...
        Xbox mother = xbox.getXbox("Mothership");
        MotherShip a = new MotherShip(jugador);
        if(a.getJugador().getCm().getRecurso1() >= costo 
           && a.getJugador().getCm().getRecurso2() >= costo){
            ...
            a.getJugador().getEd3().add(mother);
        }else{
